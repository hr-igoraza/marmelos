export const blogData = [
    ...
    description: (
      <>
        <p className="mb-4">
          ...
          and Malabar Biriyani, there exists a lesser-known world of traditional
          recipes that only the locals cherish. These flavors, passed down
          through generations, are slowly fading into history. Join us on a food
        ...
        <p className="mb-4">
          ...
          tempered with mustard seeds. Once a summer staple in Kerala
          households, it is now a rare find. If you’re lucky, you might get to
        ...
        <p className="mb-4">
          ...
          labor-intensive preparation showcases the culinary expertise of
          coastal communities. To experience its authentic taste, one must visit
        ...
        <p className="mb-4">
          ...
          more famous counterpart, Chemmeen Roast, this dish remains
          lesser-known outside local fishing villages. It pairs perfectly with
          matta rice and can be found in fishermen’s homes across Alappuzha and
          Kollam.
        </p>
        ...
        <p className="mb-4">
          ...
          dish was once a staple for laborers who needed a filling and
          energy-packed meal. Today, it is best enjoyed at village toddy shops
        ...
        <p className="mb-4">
          ...
          crunchy, deep-fried cutlets, made with a mix of spices and mashed
          lentils, are a treasure of Kerala’s plant-based cuisine. Thrissur and
        ...
        <p className="mb-4">
          ...
          and flavorful dish is best enjoyed with steamed rice and a drizzle of
          coconut oil. If you visit coastal villages in Kasaragod or Alappuzha,
        ...
        <p className="mb-4">
          ...
          after a hard day’s work. Rich in nutrients and easy to digest, this
          dish is making a slow comeback in Ayurvedic wellness retreats and
        ...
        <p className="mb-4">
          ...
          it is now a rare find. However, visiting tribal villages in Idukki and
        ...
        <p className="mb-4">
          ...
          eateries, and culinary enthusiasts to revive these lost recipes. If
          you ever visit Kerala, step off the beaten path and seek out these
          authentic flavors. Experience the real Kerala through its age-old
          culinary traditions that only the locals know.
        </p>
      </>
    ),
    authorImage: "/images/blog/recent/author.png",
    shareCount: "1K",
    datePosted: "Jan 1 ,2025",
  },
  {
    id: 102,
    image: "/images/blog/recent/blog 2.jpg",
    title: "Step Back in Time: Experiencing Authentic Tradition at Marmelos Homestay",
    description:
      "Welcome to Marmelos Homestay, where the whispers of tradition blend seamlessly with the comforts of modern life. We believe that travel is more than just seeing new places; it's about immersing yourself in the heart and soul of a culture. That's why we've woven the rich tapestry of local traditions into every aspect of your stay, offering you an unforgettable and authentic experience.Forget generic hotel experiences. At Marmelos, you'll step into a world where tradition isn't just a spectacle but a way of life. Our meals are prepared with love, using time-honored recipes passed down through generations. We source fresh, local ingredients, ensuring that every bite tells a story of our region's culinary heritage. Expect dishes that are both delicious and deeply rooted in tradition.Depending on our location, you might have the opportunity to witness or even participate in traditional crafts. Whether it's weaving, pottery, or wood carving, you'll gain a firsthand appreciation for the skill and artistry that have been preserved for centuries.We believe in genuine connection. Our family is eager to share stories of our heritage and answer your questions about local customs and traditions. We'll help you navigate the nuances of our culture, ensuring you feel welcomed and at home.Our area is steeped in history, with ancient temples, historical sites, and natural wonders that reflect the rich heritage of our region. We can arrange guided tours that delve into the stories behind these landmarks, giving you a deeper understanding of our past.At Marmelos, we don't just offer accommodation; we offer an experience. We invite you to slow down, connect with our culture, and create memories that will last a lifetime. Book your stay today and discover the magic of traditional living.",
    authorImage: "/images/blog/recent/author.png",
    shareCount: "1K",
    datePosted: "Jan 1 ,2025",
  },
  {
    id: 103,
    image: "/images/blog/recent/blog 3.jpg",
